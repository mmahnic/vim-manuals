...
if !vxlib#load#IsLoaded('manuals.plug-maps')
   call vxlib#load#SetLoaded('manuals.plug-maps', 1) 
...
if !vxlib#load#IsLoaded('manuals.keymaps')
   call vxlib#load#SetLoaded('manuals.keymaps', 1)
